...
const banners = [
	{
		...
		image:
			"https://www.run-it.com.ua/wp-content/uploads/2024/11/maxresdefault-15-1024x576.jpg",
	...
	},
	{
		...
		image:
			"https://miro.medium.com/v2/resize:fit:1400/1*LwZpgio326_WbRR15mVm8Q.png",
	...
	},
	{
		...
		name: "Creative Workspace",
		image:
			"https://media.geeksforgeeks.org/wp-content/uploads/20240423152334/front-end-developer-skill-copy.webp",
		link: "https://example.com/2",
	},
];
		...
		<div className="relative w-full">
			<div className="overflow-hidden" ref={emblaRef}>
				<div className="flex">
					{banners.map((item) => (
						<div
							className="flex-[0_0_100%] relative h-[calc(100vh-80px)]"
							key={item.id}
						>
							<Image
								src={item.image}
