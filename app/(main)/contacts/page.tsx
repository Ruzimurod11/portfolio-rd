...
const contacts = [
    {
        ...
        href: "mailto:ruzimurod_doniev@mail.ru",
    },
    {
        icon: Phone,
        label: "Telefon",
        value: "+998 50 159 96 03",
        href: "tel:+998501599603",
    },
    {
        icon: Send,
        label: "Telegram",
        value: "@ruzimurod_doniev",
        href: "https://t.me/ruzimurod_doniev",
    },
    {
        icon: FaGithub,
        label: "GitHub",
...
export default function Page() {
    return (
        <div className="min-h-screen bg-linear-to-br from-[#eff3ff] to-[#e0f0ff] flex items-center justify-center px-6 py-16">
