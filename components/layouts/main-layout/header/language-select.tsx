...
const SelectLanguage = () => {
	...
	return (
		<DropdownMenu modal={false}>
			<DropdownMenuTrigger className="flex items-center gap-2 w-24 shadow-none border-none px-2 focus:ring-0 focus:outline-none focus-visible:ring-0 data-[state=open]:ring-0 data-[state=open]:outline-none group">
				{/* Bayroq va til nomi */}
				<Image
					src={currentLang.scr}
			...
			<DropdownMenuContent className="border-background">
				{languages.map((item) => {
